%% CNN Training and Testing, modified by Aidan for RGB data sets
% Will Jarrett
...
%% Folder Information
% ===== WHAT YOU CHANGE ===== %
experimentFolder = "C:\Users\dough\OneDrive\Documents\MATLAB\EE269\EE269_Final_Project\Results\40_60_split\"; % folder for experiment (organizes everything in matlab)
dataFolder = sprintf('CNN_WCoef2_Del_10'); % this is the big folder all the output data goes in
cnnFolder = "C:\Users\dough\OneDrive\Documents\MATLAB\EE269\EE269_Final_Project\DataProcessing\WCoef2_Del_10"; %folder of images
...
audsTrain = augmentedImageDatastore([res res 3], imdsTrain, 'DataAugmentation', augmenter);
audsVali  = augmentedImageDatastore([res res 3], imdsVali, 'DataAugmentation', augmenter);
audsTest  = augmentedImageDatastore([res res 3], imdsTest, 'DataAugmentation', augmenter);
...
layers = [
    imageInputLayer([res res 3],'NormalizationDimension','channel'); % input layer - images are 64x64x3 RGB
