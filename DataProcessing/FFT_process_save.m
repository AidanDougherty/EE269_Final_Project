function FFT_process_save(dirpath, writepath) %For Applying LPF in K-space and IFFT Back
arguments
    ...
    writepath = "C:\Users\dough\OneDrive\Documents\MATLAB\EE269\EE269_Final_Project\DataProcessing\LPFBeam_Del_10\"; % Folder to write Beam png's
end
...
for y = 1:NBeams
    ...
    for i = 1:size(fsrc, 1)
        ...
        imwrite(beam_filt, strcat(writepath, beam_dir_name, "\", fsrc(i).name))
    end
end
