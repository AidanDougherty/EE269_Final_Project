...
%% Folder Information
% ===== WHAT YOU CHANGE ===== %
experimentFolder = sprintf('IEEE_Paper/RB_256'); % folder for experiment (organizes everything in matlab)
dataFolder = sprintf('Del_1/A_Strong'); % this is the big folder all the data goes in
cnnFolder = sprintf('For_CNN_64');
imNum = 1000; % number of images per beam
totalBeams = 255; % total number of beams being classified
trainImg = 500; % number of images per beam used for training
testImg = 500; % number of images used per beam for testing
